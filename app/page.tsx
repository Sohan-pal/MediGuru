    ...
    <>
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 leading-relaxed">
          Experience healthcare guidance powered by advanced AI. Get instant
          medical information, symptom analysis, and health recommendations at
          your fingertips.
        </p>
        <button
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg mb-8 text-blue-50">
            Subscribe to our newsletter for the latest updates in AI-powered
